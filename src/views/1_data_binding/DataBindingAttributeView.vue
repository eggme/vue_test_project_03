...
<div>
  ...
  <a href="/about">aboutd으로 이동</a>
  <br />
  <br />
  <img :src="imgSrc" style="withd:100px; height:100px">
  <br />
  <input type="tel" name="" id="" v-model="text1">
...
export default {
  ...
  data () {
    return {
      value: 'DataBindingAttributeView',
      userId: 'kyyeto9984',
  ...
  setup () {
    console.warn(this.text1 === this.text2)
  },
  created () {
  },
  mounted () {
